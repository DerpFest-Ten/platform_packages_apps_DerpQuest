...
public class NavigationHolder extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (derpUtils.isThemeEnabled("com.android.internal.systemui.navbar.gestural")
                ...
                || derpUtils.isThemeEnabled("com.android.internal.systemui.navbar.gestural_extra_wide_back_nopill")
    ...
    private boolean isNavbarVisible() {
        boolean defaultToNavigationBar = derpUtils.deviceSupportNavigationBar(getActivity());
    ...
    private void navbarCheck() {
        ...
        if (derpUtils.isThemeEnabled("com.android.internal.systemui.navbar.twobutton") && isNavbarVisible()) {
            homeCategory.setEnabled(true);
            backCategory.setEnabled(true);
            menuCategory.setVisible(false);
            assistCategory.setVisible(false);
        ...
        if (derpUtils.isThemeEnabled("com.android.internal.systemui.navbar.threebutton")) {
            ...
            rightSwipeCategory.setVisible(false);
            mGestureBarSize.setVisible(false);
        } else if (derpUtils.isThemeEnabled("com.android.internal.systemui.navbar.twobutton")) {
            ...
            rightSwipeCategory.setVisible(false);
            mGestureBarSize.setVisible(false);
        } else if (derpUtils.isThemeEnabled("com.android.internal.systemui.navbar.gestural_narrow_back")
